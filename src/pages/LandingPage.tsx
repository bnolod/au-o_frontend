    ...
    <div className="sm:max-h-screen sm:h-screen bg-backgroundGradient overflow-hidden">
      ...
      <main className="flex flex-col text-textColor h-full p-16">
        <div className="flex flex-col lg:flex-row justify-center items-center lg:h-1/2 p-4">
          ...
          <img className="basis-7/12 h-full" src="assets/FrontDecoration.svg" alt="" />
        </div>
        <div className="flex flex-col lg:flex-row items-center justify-center flex-grow p-4  ">
          <ScrollableDisplay className="basis-5/12 p-5" language={language} />
          <div className="flex flex-col items-center basis-7/12 text-center p-5">
